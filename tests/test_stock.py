...
class TestStockConstructor(unittest.TestCase):
    ...
    def test_create_stock_3(self,):
        ...
        self.assertIn(fs.CUSIP('testing123'), tsla.identifiers,)
        self.assertIn(fs.FIGI('12345'), tsla.identifiers,)
        self.assertIn(fs.ISIN('memeer'), tsla.identifiers,)
    ...
    def test_create_stock_fail_1(self,):
        tsla = fs.Stock(
            ticker = 'TSLA',
        )
